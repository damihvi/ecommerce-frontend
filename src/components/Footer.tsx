        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/damihvi" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.328-1.297L6.548 14.264c.548.548 1.297.848 2.098.848 1.647 0 2.998-1.347 2.998-2.998 0-.8-.3-1.55-.848-2.098l1.427-1.427c.807.88 1.297 2.031 1.297 3.328 0 2.645-2.152 4.797-4.797 4.797h-.274zm7.674 0c-2.645 0-4.797-2.152-4.797-4.797 0-1.297.49-2.448 1.297-3.328l1.427 1.427c-.548.548-.848 1.298-.848 2.098 0 1.651 1.351 2.998 2.998 2.998.8 0 1.55-.3 2.098-.848l1.427 1.427c-.88.807-2.031 1.297-3.328 1.297h-.274z"/>
              ...
              {/* TikTok */}
              <a 
                href="https://www.tiktok.com/@damihvi?is_from_webapp=1&sender_device=pc" 
                target="_blank" 
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="group-hover:text-blue-500">Facebook</span>
              </a>
